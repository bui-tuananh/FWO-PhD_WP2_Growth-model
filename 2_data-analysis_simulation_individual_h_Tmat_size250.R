...
df_nll <- read_rds("./output/backcal_hmm_simulation_h_Tmat_v2_nll_size250.rds")
list_opt <- read_rds("./output/backcal_hmm_simulation_h_Tmat_v2_opt_size250.rds")
list_obj <- read_rds("./output/backcal_hmm_simulation_h_Tmat_v2_obj_size250.rds")
...
for(i in 1:10000) {
    ...
    for(j in 1:100) {
        ...
        write_rds(df_nll, "./output/backcal_hmm_simulation_h_Tmat_v2_nll_size250.rds")
        write_rds(list_opt, "./output/backcal_hmm_simulation_h_Tmat_v2_opt_size250.rds")
        write_rds(list_obj, "./output/backcal_hmm_simulation_h_Tmat_v2_obj_size250.rds")
