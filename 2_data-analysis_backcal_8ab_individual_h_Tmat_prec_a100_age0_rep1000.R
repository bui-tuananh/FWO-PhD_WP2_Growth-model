...
list_opt <- list()
list_obj <- list()
# df_nll <- read_rds("./output/backcal_8ab_individual_h_Tmat_prec_a100_age0_rep1000_v2_nll.rds")
# list_opt <- read_rds("./output/backcal_8ab_individual_h_Tmat_prec_a100_age0_rep1000_v2_opt.rds")
# list_obj <- read_rds("./output/backcal_8ab_individual_h_Tmat_prec_a100_age0_rep1000_v2_obj.rds")
...
for(i in 1:10000) {
    ...
    write_rds(df_nll, "./output/backcal_8ab_individual_h_Tmat_prec_a100_age0_rep1000_v2_nll.rds")
    write_rds(list_opt, "./output/backcal_8ab_individual_h_Tmat_prec_a100_age0_rep1000_v2_opt.rds")
    write_rds(list_obj, "./output/backcal_8ab_individual_h_Tmat_prec_a100_age0_rep1000_v2_obj.rds")
